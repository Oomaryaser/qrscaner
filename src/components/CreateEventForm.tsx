  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={submit} className="space-y-6">
        ...
        {error && (
          <div className="bg-red-50 border border-red-200 rounded-xl p-4 flex items-start space-x-reverse space-x-3 animate-slideIn">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center justify-between mt-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center space-x-reverse space-x-2 px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg text-sm font-medium transition-all duration-200"
                >
                  <span>معاينة</span>

                            ...
                            {isActive ? 'نشطة الآن' : isUpcoming ? 'قادمة' : 'منتهية'}
                                    ...
                                    <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                                        <div className="flex items-center gap-3">
                                            <Link
                                                href={`/e/${ev.id}`}
                                                className="inline-flex items-center  space-x-2 px-6 py-2.5 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl font-medium hover:from-blue-600 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl btn-hover-scale focus-ring"
                                            >
                                            ...
                                            <Link
                                                href={`/e/${ev.id}/scan`}
                                                className="inline-flex items-center  space-x-2 px-6 py-2.5 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-xl font-medium hover:from-green-600 hover:to-emerald-700 transition-all duration-300 shadow-lg hover:shadow-xl btn-hover-scale focus-ring"
                                            >
                                                <span>مسح QR</span>
                                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <ResetAttendanceButton eventId={ev.id} />
                                        </div>
                                    </div>
                                </div>
                            );
